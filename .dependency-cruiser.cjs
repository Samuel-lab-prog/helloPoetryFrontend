...
module.exports = {
	forbidden: [
		{
			name: 'ignore-dev-dep-vite-env',
			severity: 'ignore',
			comment: 'Ignore devDependency warnings for vite-env.d.ts',
			from: {
				pathNot: 'src/vite-env.d.ts',
			},
			to: {
...
// generated: dependency-cruiser@17.3.5 on 2025-12-29T11:42:16.866Z
